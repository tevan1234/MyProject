...
<html>
	...
	<body style="background-color: #f4e500">
		...
		<div style="padding: 15px ">
			<form class="pure-form" method="post" action="/InsuranceSystem/user/add">
				<fieldset>
					<legend>使用者新增</legend>
				...
				<table id="myTable" class="pure-table pure-table-bordered" style="background-color: white;">
					...
					<%for(UserDto userDto : userDtos) { %>
						<tr>
							...
							<td><a href="/InsuranceSystem/user/get?username=<%= userDto.getUname() %>" class="button-secondary pure-button">修改</a></td>
							<td><a href="/InsuranceSystem/user/delete?userId=<%= userDto.getUid() %>" class="button-error pure-button">刪除</a></td>
						</tr>
					<% } %>
				</table>
			</fieldset>
